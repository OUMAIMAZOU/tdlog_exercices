...
class TestExo3(unittest.TestCase):
    def test_input_1(self):
        ...
        with open("sample/output1.txt") as output1:
            expected = output1.read().strip()  # Supprimer les espaces ou nouvelles lignes supplémentaires
    ...
    def test_input_2(self):
        ...
        with open("sample/output2.txt") as output2:
            expected = output2.read().strip()  # Supprimer les espaces ou nouvelles lignes supplémentaires
